...
function cetakMhs({ // Jadi ini kita PECAHKAN semua OBJECT didalam ARGUMENT NYA
    ...
    umur,
    nilai: {
        nilaiUAS // Jadi bisa juga kita PECAH CHILD dari OBJECT didalam arguments
    },
    makan: {
        ringan: {
    ...
    return test `Halo, nama saya ${nama}, saya berumur ${umur} tahun. dan nilai UAS saya adalah ${nilaiUAS}, lalu makanan kesukaan saya adalah ${Cemilan} dan hobi saya adalah ${ruangan} lalu Games kesukaan saya adalah ${moba[0]}`
}
