...
// session adalah suatu cara untuk membuat user tidak bisa mengakses ke halaman tertentu sebelum melakukan login terlebih dahulu
    ...
    if (mysqli_num_rows($result) === 1) {
        ...
        if (password_verify($password, $row["password"])) {
            ...
            if (isset($_POST["remember"])) {
                ...
                setcookie('key', hash('sha256', $row["username"]), time() + 60 * 60 * 24 * 2);
